...
dice(np.load("7.0-150.0-5.0-Data_0001.npz")['data'][:,:,:,0], np.load("12.0-30.0-3.7-Data_0001.npz")['data'][:,:,:,0], [0.8, 0.7])

dice(np.load("7.0-150.0-5.0-Data_0001.npz")['data'][:,:,:,0], np.load("12.0-30.0-3.7-Data_0001.npz")['data'][:,:,:,0], [0.13, 0.45])
