...
xyz_checkpoint = torch.load("/mnt/Drive2/ivan_kevin/log/torchimpl/0701-09-37-48-v7-necr-normpet-nonorm-batch32-wd05-xyz/epoch48.pt", map_location=torch.device('cpu'))
xyz_model.load_state_dict(xyz_checkpoint['model_state_dict'])

growth_checkpoint = torch.load("/mnt/Drive2/ivan_kevin/log/torchimpl/1401-21-45-28-v7_1-necr-normpet-nonorm-batch32-wd05-outputmode4/epoch50.pt", map_location=torch.device('cpu'))
