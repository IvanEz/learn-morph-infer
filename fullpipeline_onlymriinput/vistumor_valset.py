...
zslice = args.zslice
simulated = glob("/mnt/Drive2/ivan_kevin/21-2-onlymri/inverse_tumor_surrogate/fullpipeline_onlymriinput/npzresults/sim/{}-*-Data_0001.npz".format(80000 + identifier))
...
toevaluatepaths = sorted(glob("{}/*/".format("/mnt/Drive2/ivan_kevin/samples_extended_thr2/Dataset/")))[80000 : 88000]

groundtruth = toevaluatepaths[identifier]

thresholds = np.load("/mnt/Drive2/ivan_kevin/21-2-onlymri/inverse_tumor_surrogate/fullpipeline_onlymriinput/scanthresholds.npz")

t1gd = thresholds['t1gd'][80000:88000][identifier]
flair = thresholds['flair'][80000:88000][identifier]
#necrotic = thresholds['necrotic'][0:12000][identifier]

print(f"{groundtruth}, {t1gd}, {flair}")
...
f=mlab.figure(); mlab.volume_slice(mri_scan,figure=f,plane_orientation='z_axes',slice_index=zslice)
