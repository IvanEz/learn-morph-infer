...
zslice = args.zslice
simulated = glob("/mnt/Drive2/ivan_kevin/4-3-onlymri-testset/inverse_tumor_surrogate/fullpipeline_onlymriinput/npzresults/sim/{}-*-Data_0001.npz".format(identifier))
