...
+python3 main.py --random_seed=32126 --fchdepth=0 --fcsize=3 --starttraindata=0 --endtraindata=20000 --startvaldata=80000 --endvaldata=82000 --outputparams=3 --filters=2 --num_conv=3 --log_step=32 --batch_size=32 --num_worker=8 --is_train True --gpu_id="1" --max_epoch=4 --lr_max=0.001 --lr_min=0.00000025 --beta1=0.9 --tag 'inverse_test_notthresholded_Dw_rho_T' --log_dir '/mnt/Drive2/ivan_kevin/log' --data_dir '/mnt/Drive2/ivan_kevin/samples_extended_copy' --dataset 'Dataset'
