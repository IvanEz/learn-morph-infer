...
misc_arg.add_argument('--log_dir', type=str, default='../deep_data/log')
misc_arg.add_argument('--tag', type=str, default='tag')
misc_arg.add_argument('--data_dir', type=str, default='../deep_data/data')
misc_arg.add_argument('--load_path', type=str, default='')
misc_arg.add_argument('--inf_save', type=str, default='')
misc_arg.add_argument('--code_path', type=str, default='')
misc_arg.add_argument('--log_step', type=int, default=500)
misc_arg.add_argument('--test_step', type=int, default=200)
